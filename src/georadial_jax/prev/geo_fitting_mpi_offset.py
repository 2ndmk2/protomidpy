...
def RBF_add_noise(obst, alpha, gamma, simga = 1e-3):
...
def main(N_RAD=30, D_PIX= None, DO_TEST_CALC=True, DO_MCMC=True, TAKE_RANDOM_SAMPLE = True, MCMC_RUN=10000, NWALKER=32, \
    ...
    for file in vis_files:
        ...
        if DO_TEST_CALC:
            ...
            pa_test = 58.85 * np.pi/180 
            inc_test = 0.2872 
            delta_x_test = 0.0765 * ARCSEC_TO_RAD 
            delta_y_test = -0.0636 * ARCSEC_TO_RAD
            I0_test =0.0005
